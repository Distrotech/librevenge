...
WP3WindowGroup::WP3WindowGroup(RVNGInputStream *input, RVNGEncryption *encryption) :
...
void WP3WindowGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
	switch (getSubGroup())
	{
...
{
	RVNG_DEBUG_MSG(("WordPerfect: handling a Window group\n"));
