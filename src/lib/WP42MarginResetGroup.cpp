...
WP42MarginResetGroup::WP42MarginResetGroup(RVNGInputStream *input, RVNGEncryption *encryption, uint8_t group) :
...
void WP42MarginResetGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
