...
WP1TopMarginGroup::WP1TopMarginGroup(WPXInputStream *input, WPXEncryption *encryption, uint8_t group) :
...
void WP1TopMarginGroup::_readContents(WPXInputStream *input, WPXEncryption *encryption)
{
