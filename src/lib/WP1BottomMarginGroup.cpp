...
WP1BottomMarginGroup::WP1BottomMarginGroup(RVNGInputStream *input, RVNGEncryption *encryption, uint8_t group) :
...
void WP1BottomMarginGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
...
{
	RVNG_DEBUG_MSG(("WordPerfect: handling the Bottom Margin group\n"));
