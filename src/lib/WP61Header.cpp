...
WP61Header::WP61Header(RVNGInputStream *input, RVNGEncryption *encryption, uint32_t documentOffset, uint8_t productType,
	...
	m_documentSize(0)
{
	...
	RVNG_DEBUG_MSG(("WordPerfect: Document End Position = 0x%x \n",(int)m_documentSize));
