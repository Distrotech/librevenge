...
class WP3ContentListener : public WP3Listener, protected RVNGContentListener
{
public:
	WP3ContentListener(std::list<RVNGPageSpan> &pageList, std::vector<WP3SubDocument *> &subDocuments, RVNGDocumentInterface *documentInterface);
	~WP3ContentListener();
	...
	void columnChange(RVNGTextColumnType columnType, uint8_t numColumns, const std::vector<double> &columnWidth,
