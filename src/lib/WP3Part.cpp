...
WP3Part *WP3Part::constructPart(RVNGInputStream *input, RVNGEncryption *encryption, const uint8_t readVal)
{
	RVNG_DEBUG_MSG(("WordPerfect: ConstructPart for group 0x%x\n", readVal));
