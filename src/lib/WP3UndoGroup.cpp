...
WP3UndoGroup::WP3UndoGroup(RVNGInputStream *input, RVNGEncryption *encryption, uint8_t groupID) :
...
void WP3UndoGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
