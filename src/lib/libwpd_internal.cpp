...
static const uint32_t international1WP5[] = {
  0x0300, 0x00b7, 0x0303, 0x0302, 0x0335, 0x0338, 0x0301, 0x0308,
  0x0304, 0x0313, 0x0315, 0x02bc, 0x0326, 0x0315, 0x00b0, 0x0307,
  0x030b, 0x0327, 0x0328, 0x030c, 0x0335, 0x0305, 0x0306, 0x00df,
  0x0131, 0x0237, 0x00c1, 0x00e1, 0x00c2, 0x00e2, 0x00c4, 0x00e4,
  0x00c0, 0x00e0, 0x00c5, 0x00e5, 0x00c6, 0x00e6, 0x00c7, 0x00e7,
  0x00c9, 0x00e9, 0x00ca, 0x00ea, 0x00cb, 0x00eb, 0x00c8, 0x00e8,
  0x00cd, 0x00ed, 0x00ce, 0x00ee, 0x00cf, 0x00ef, 0x00cc, 0x00ec,
  0x00d1, 0x00f1, 0x00d3, 0x00f3, 0x00d4, 0x00f4, 0x00d6, 0x00f6,
...
static const uint32_t boxdrawingWP5[] = {
  0x2591, 0x2592, 0x2593, 0x2588, 0x258c, 0x2580, 0x2590, 0x2584,
  0x2500, 0x2502, 0x250c, 0x2510, 0x2518, 0x2514, 0x251c, 0x252c,
  0x2524, 0x2534, 0x253c, 0x2550, 0x2551, 0x2554, 0x2557, 0x255d,
  0x255a, 0x2560, 0x2566, 0x2563, 0x2569, 0x256c, 0x2552, 0x2555,
...
static const uint32_t typographicWP5[] = {
  0x25cf, 0x25cb, 0x25a0, 0x2022, 0x002a, 0x00b6, 0x00a7, 0x00a1,
  0x00bf, 0x00ab, 0x00bb, 0x00a3, 0x00a5, 0x20a7, 0x0192, 0x00aa,
  0x00ba, 0x00bd, 0x00bc, 0x00a2, 0x00b2, 0x207f, 0x00ae, 0x00a9,
  0x00a4, 0x00be, 0x00b3, 0x201b, 0x2019, 0x2018, 0x201f, 0x201d,
  ...
  0x2026, 0x0024, 0x20a3, 0x20a2, 0x20a0, 0x20a4, 0x201a, 0x201e,
  0x2153, 0x2154, 0x215b, 0x215c, 0x215d, 0x215e, 0x24c2, 0x24c5,
  0x24ca, 0x2105, 0x2106, 0x2030, 0x2116, 0x2014, 0x00b9, 0x2409,
...
static const uint32_t mathextWP5[] = {
...
static const uint32_t cyrillicWP5[] = {
  ...
  0x0472, 0x0473, 0x0474, 0x0475, 0x046a, 0x046b, 0x0496, 0x0497, // 96 - 103
  0x0429, 0x0449, 0x04a4, 0x04a5, 0x0466, 0x0467, 0x0000, 0x0000, // 104 - 111
  0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x04f2, 0x04f3, // 112 - 119
  ...
  0x0000, 0x0000, 0x0000, 0x0000, 0x030b, 0x0300                  // 144 - 149
};

/* WP5 cyrillic (charset 10) - multicharacter mapping */
static const WPXComplexMap cyrillicWP5Complex[] = {
  { 110, { 0x030b, 0x0410, 0x0000 } }, { 111, { 0x030b, 0x0430, 0x0000 } },
  { 112, { 0x030b, 0x0415, 0x0000 } }, { 113, { 0x030b, 0x0435, 0x0000 } },
  { 114, { 0x030b, 0x0418, 0x0000 } }, { 115, { 0x030b, 0x0458, 0x0000 } },
  { 116, { 0x030b, 0x041e, 0x0000 } }, { 117, { 0x030b, 0x043e, 0x0000 } },

  { 120, { 0x030b, 0x042b, 0x0000 } }, { 121, { 0x030b, 0x044b, 0x0000 } },
  { 122, { 0x030b, 0x042d, 0x0000 } }, { 123, { 0x030b, 0x044d, 0x0000 } },
  { 124, { 0x030b, 0x042e, 0x0000 } }, { 125, { 0x030b, 0x044e, 0x0000 } },
  { 126, { 0x030b, 0x042f, 0x0000 } }, { 127, { 0x030b, 0x044f, 0x0000 } },
  { 128, { 0x0300, 0x0410, 0x0000 } }, { 129, { 0x0300, 0x0430, 0x0000 } },

  { 132, { 0x0300, 0x0401, 0x0000 } }, { 133, { 0x0300, 0x0451, 0x0000 } },

  { 136, { 0x0300, 0x041e, 0x0000 } }, { 137, { 0x0300, 0x043e, 0x0000 } },
  { 138, { 0x0300, 0x0423, 0x0000 } }, { 139, { 0x0300, 0x0443, 0x0000 } },
  { 140, { 0x0300, 0x042b, 0x0000 } }, { 141, { 0x0300, 0x044b, 0x0000 } },
  { 142, { 0x0300, 0x042d, 0x0000 } }, { 143, { 0x0300, 0x044d, 0x0000 } },
  { 144, { 0x0300, 0x042e, 0x0000 } }, { 145, { 0x0300, 0x044e, 0x0000 } },
  { 146, { 0x0300, 0x042f, 0x0000 } }, { 147, { 0x0300, 0x044f, 0x0000 } },
			    ...
			    uint8_t characterSet, const uint32_t **chars)
{
	...
	case WP5_INTERNATIONAL_1_CHARACTER_SET:
		if ((retVal = findSimpleMap(character, chars, international1WP5, WPD_NUM_ELEMENTS(international1WP5))))
			return retVal;
		break;
	...
	case WP5_BOX_DRAWING_CHARACTER_SET:
		if ((retVal = findSimpleMap(character, chars, boxdrawingWP5, WPD_NUM_ELEMENTS(boxdrawingWP5))))
			return retVal;
		break;

	case WP5_TYPOGRAPHIC_SYMBOL_CHARACTER_SET:
		if ((retVal = findSimpleMap(character, chars, typographicWP5, WPD_NUM_ELEMENTS(typographicWP5))))
			return retVal;
		break;
	...
	case WP5_MATH_SCIENTIFIC_CHARACTER_SET:
		if ((retVal = findSimpleMap(character, chars, mathWP5, WPD_NUM_ELEMENTS(mathWP5))))
			return retVal;
		break;

	case WP5_MATH_SCIENTIFIC_EXTENDED_CHARACTER_SET:
		if ((retVal = findSimpleMap(character, chars, mathextWP5, WPD_NUM_ELEMENTS(mathextWP5))))
			return retVal;
		break;
