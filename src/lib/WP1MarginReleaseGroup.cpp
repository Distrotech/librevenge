...
WP1MarginReleaseGroup::WP1MarginReleaseGroup(WPXInputStream *input, uint8_t group) :
...
void WP1MarginReleaseGroup::_readContents(WPXInputStream *input)
{
	m_release = readU16(input, true);
}
