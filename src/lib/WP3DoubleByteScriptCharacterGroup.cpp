...
WP3DoubleByteScriptCharacterGroup::WP3DoubleByteScriptCharacterGroup(RVNGInputStream *input, RVNGEncryption *encryption, uint8_t groupID) :
...
void WP3DoubleByteScriptCharacterGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
