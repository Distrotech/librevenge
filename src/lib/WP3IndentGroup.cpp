...
WP3IndentGroup::WP3IndentGroup(RVNGInputStream *input, RVNGEncryption *encryption, uint8_t groupID) :
...
void WP3IndentGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
