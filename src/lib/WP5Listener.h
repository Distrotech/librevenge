...
public:
	...
	virtual void setTabs(const std::vector<RVNGTabStop> &tabStops, uint16_t tabOffset) = 0;
	...
	virtual void insertNote(RVNGNoteType noteType, const WP5SubDocument *subDocument) = 0;
