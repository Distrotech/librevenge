...
WP3EndOfLinePageGroup::WP3EndOfLinePageGroup(RVNGInputStream *input, RVNGEncryption *encryption) :
...
{
	RVNG_DEBUG_MSG(("WordPerfect: handling an End of Line/Page group\n"));
