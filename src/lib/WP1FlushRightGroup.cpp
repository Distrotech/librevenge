...
WP1FlushRightGroup::WP1FlushRightGroup(RVNGInputStream *input, RVNGEncryption *encryption, uint8_t group) :
...
{
	RVNG_DEBUG_MSG(("WordPerfect: handling the Flush Right group\n"));
