...
WP6OutlineStylePacket::WP6OutlineStylePacket(WPXInputStream *input, int id, guint32 dataOffset, guint32 dataSize) 
...
void WP6OutlineStylePacket::parse(WP6HLListener *listener) const
{
