...
WP3FontGroup::WP3FontGroup(RVNGInputStream *input, RVNGEncryption *encryption) :
...
void WP3FontGroup::_readContents(RVNGInputStream *input, RVNGEncryption *encryption)
{
